  ...
  constructor(props) {
    ...
    this.state = {
      members: [
        ...
        {name: 'Mihir Desai', role: 'Procrastinator', image: 'mihir-desai.jpg', github: 'zvuve'},
        ...
        {name: 'Sarvesh Shinde', role: 'Captain Normie', image: 'sarvesh-shinde.jpg', github: 'illitus'},
            ...
            <div className="container">
              ...
              {this.state.members.map(function(member) { return (
                <div className="column is-3">
                  ...
                  <div className="is-size-6 has-text-centered"><a href={"https://github.com/" + member.github} target="_blank" rel="noopener noreferrer"><i className="fab fa-github"/> {member.github}</a></div>
                </div>
              )})}
              </div>
            </div>
